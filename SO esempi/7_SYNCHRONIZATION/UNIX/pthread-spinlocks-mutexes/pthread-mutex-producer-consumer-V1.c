...
pthread_mutex_t available_data[SIZE];	// un mutex per ogni elemento dati (consumer)
pthread_mutex_t available_slot[SIZE];	// un mutex per ogni elemento slot (producer)
