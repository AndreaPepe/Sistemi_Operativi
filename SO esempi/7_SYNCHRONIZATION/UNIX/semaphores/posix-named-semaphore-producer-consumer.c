...
int main(int argc, char** argv){
	...
	for (i=0; i<SIZE; i++){		// open su ogni slot del semaforo!!!
		sprintf(buff,"slot%d\0",i);	// semaphore names
		sem_free_slot[i] = sem_open(buff,O_CREAT,0666,1);	// sem_open: NAMED SEMAPHORES
