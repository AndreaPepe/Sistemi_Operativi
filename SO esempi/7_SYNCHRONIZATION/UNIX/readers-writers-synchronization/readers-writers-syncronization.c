...
int sem_write, sem_read;	// 1 semaforo per lo scrittore, 1 per i lettori
...
int main(int argc, char** argv){
	...
	semctl(sem_read,0,SETVAL,NUM_READERS);		// # gettoni = NUM_READERS
...
respawn:
	...
	if(++i < NUM_READERS) goto respawn;	// spawn di NUM_READERS lettori
